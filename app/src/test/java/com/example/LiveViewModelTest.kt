...
class LiveViewModelTest {
    ...
    fun categoryObserverFailure_withHideMode_doesNotExposeAdultChannel() = runTest {
        ...
        val adultChannel = LiveChannel("ch1", "Adult", "url", "", "cat_1", "Cat 1", "", 1, false, true)
    ...
    fun categoryObserverFailure_withHideMode_doesNotExposeLockedCategoryChannel() = runTest {
        ...
        val lockedChannel = LiveChannel("ch1", "Locked", "url", "", "cat_1", "Cat 1", "", 1, false, false)
    ...
    fun categoryObserverFailure_stillExposesUnrelatedSafeChannel() = runTest {
        ...
        val safeChannel = LiveChannel("ch1", "Safe", "url", "", "cat_1", "Cat 1", "", 1, false, false)
    ...
    fun zeroTotalNonAuthoritativeSnapshot_stillAppliesAdultFiltering() = runTest {
        ...
        fakeLive.snapshotEmissions = listOf(LiveCategoryVisibilitySnapshot(0, emptyList()))
        vm.onLiveVisibilityChanged(true)
        advanceUntilIdle()
    ...
    fun parentalDisable_restoresCachedChannelsWithoutReloading() = runTest {
        ...
        val ch1 = LiveChannel("ch1", "Ch 1", "url", "", "cat_1", "Cat 1", "", 1, false, true)
        fakeLive.channelsEmissions = listOf(listOf(ch1))
        fakeLive.snapshotEmissions = listOf(LiveCategoryVisibilitySnapshot(1, listOf(Category("cat_1", "Cat 1", "LIVE"))))
    ...
    fun providerHidden_staleCategorySelection_performsNoChannelRequest() = runTest {
        ...
        val cat1 = Category("cat_1", "Cat 1", "LIVE")
        fakeLive.categoriesEmissions = listOf(listOf(cat1))
        fakeLive.snapshotEmissions = listOf(LiveCategoryVisibilitySnapshot(1, emptyList()))
    ...
    fun providerHidden_staleChannelClick_emitsNoPlayback() = runTest {
        ...
        val ch1 = LiveChannel("ch1", "Ch 1", "url", "", "cat_1", "Cat 1", "", 1, false, false)
        ...
        advanceUntilIdle()
        assertTrue(vm.uiState.value.pendingParentalChannel == null)
    }
